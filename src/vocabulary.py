...
if __name__ == '__main__':
	...
	parent_dir = list(data_path.split('/')[:-1])
	all_vocabulary_file = '/'.join(parent_dir+["all_structures.txt"])
	select_vocabulary_file = '/'.join(parent_dir+["vocabulary.txt"])
	min_show_time = args.threshold
